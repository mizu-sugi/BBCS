...
<?php $__env->startSection('content'); ?>
    ...
    <div id="chart-data"
         data-labels="<?php echo e(json_encode($labels)); ?>"
         data-temperatures="<?php echo e(json_encode($temperatures)); ?>"
         data-nausea-levels="<?php echo e(json_encode($nauseaLevels)); ?>"
         data-fatigue-levels="<?php echo e(json_encode($fatigueLevels)); ?>"
         data-pain-levels="<?php echo e(json_encode($painLevels)); ?>"
         data-appetite-levels="<?php echo e(json_encode($appetiteLevels)); ?>"
         data-numbness-levels="<?php echo e(json_encode($numbnessLevels)); ?>"
         data-anxiety-levels="<?php echo e(json_encode($anxietyLevels)); ?>">
    </div>
...
<?php echo $__env->make('layouts.users', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/members/health-records/index.blade.php ENDPATH**/ ?>