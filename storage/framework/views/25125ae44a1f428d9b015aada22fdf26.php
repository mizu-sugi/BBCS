    ...
    <div class="mb-6 py-4 bg-white rounded">
        ...
        <div class="pt-4 px-4 overflow-x-auto">
            <table class="table-auto w-full">
                ...
                <tr class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-sm', 'bg-gray-50' => $loop->odd]); ?>">
                    <td class="flex px-4 py-3 items-center">
                        <img class="w-12 h-12 mr-4 object-cover rounded-md" src="<?php echo e(asset('storage/'. $blog->image)); ?>" alt="">
                        <p class="font-medium"><a href="<?php echo e(route('admin.blogs.edit', ['blog' => $blog])); ?>"><?php echo e($blog->title); ?></a></p>
                    </td>
                    <td class="font-medium"><?php echo e($blog->category->name); ?></td>
                    <td class="font-medium">高橋</td>
                    <td><?php echo e($blog->updated_at); ?></td>
                    <td>
                        <div class="flex">
                            <a class="mr-2" href="<?php echo e(route('admin.blogs.edit', ['blog' => $blog->id])); ?>">
        ...
        <!-- ▼▼▼▼ページャー▼▼▼▼　-->
<?php echo e($blogs->onEachSide(2)->links()); ?>
