          ...
          <?php $__currentLoopData = $latestBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="flex-1 max-w-1/3 box-border px-6 mb-6">
              <a href="<?php echo e(route('blogs.show', $blog->id)); ?>">
                <p class="mb-6">
                  <img src="<?php echo e(asset('storage/'. $blog->image)); ?>" alt="ブログ画像">
                </p>
                <div class="px-4 pt-6">
                  <h3 class="text-xl font-bold mb-6"><?php echo e($blog->title); ?></h3>
                  <p class="text-justify leading-relaxed mb-4"><?php echo e(Str::limit($blog->body, 100)); ?></p>
                  <p class="text-gray-600"><?php echo e($blog->updated_at->format('Y.m.d')); ?></p>
                </div>
              </a>
            </li>
