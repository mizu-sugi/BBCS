    ...
    <div class="container px-4 mx-auto">
      <div class="flex max-w-md mx-auto flex-col text-center">
        <div class="mt-12 mb-8 p-8 bg-white rounded shadow">
          <h1 class="mb-6 text-3xl">Member Login</h1>
          ...
          <form action="<?php echo e(route('members.login')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/members/login.blade.php ENDPATH**/ ?>