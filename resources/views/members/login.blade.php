        ...
        <div class="mt-12 mb-8 p-8 bg-white rounded shadow">
          ...
          <form action="{{ route('members.login') }}" method="POST">
            ...
            <div class="flex mb-4 px-4 bg-blueGray-50 rounded">
              <input class="w-full py-4 text-xs placeholder-blueGray-400 font-semibold leading-none bg-blueGray-50 outline-none" type="email" placeholder="e-mail" name="email" value="{{ old('email') }}">
